...
private:
  ...
  void plan2graph_O_CMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph);

  void initialize_J_RI_CMAX(Lisa_Matrix<bool>* SIJ,Lisa_MO* MO);
  void initialize_O_RI_CMAX(Lisa_Matrix<bool>* SIJ);
  void plan2graph_J_RI_CMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph);
  void plan2graph_O_RI_CMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph); 

  void initialize_J_LMAX(Lisa_Matrix<bool>* SIJ,Lisa_MO* MO);
  void initialize_O_LMAX(Lisa_Matrix<bool>* SIJ);
  void plan2graph_J_LMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph);
  void plan2graph_O_LMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph);

  void initialize_J_RI_LMAX(Lisa_Matrix<bool>* SIJ,Lisa_MO* MO);
  void initialize_O_RI_LMAX(Lisa_Matrix<bool>* SIJ);
  void plan2graph_J_RI_LMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph);
  void plan2graph_O_RI_LMAX(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph); 
  //@}
...
public:
  ...
  Lisa_MatrixGraph*  get_disjkt();
  
  /// converts a plan of the current problem to the according plangraph
  void plan2graph(Lisa_Matrix<int>* plan,Lisa_MatrixGraph* plangraph);
  
  /// converts a plangraph back to the plan 
  void graph2plan(Lisa_MatrixGraph* plangraph,Lisa_Matrix<int>* plan);
