...
// following parameters are possible:
  ...
  //static const int API       = 21;
  //static const int SHIFT     = 22;
  //static const int 3_API     = 23;
  //static const int CR_API    = 24;
  //static const int BL_API    = 25;
  //static const int CR_SHIFT  = 26;
  //static const int BL_SHIFT  = 27;
  //static const int 3_CR      = 28;
  ...
  int nb_iter(Lisa_Values& Values,Lisa_List<Lisa_ScheduleNode>& Starters,Lisa_List<Lisa_ScheduleNode>& Results){
    // ####  SINGLE-MACHINE   ####
    if ( PROB_TYPE == ONE )
      return one_mach_iter(Values, Starters, Results);
    // ####  END OF SINGLE-MACHINE  ####
    
    // ####  OPEN-SHOP  ####
    if ( PROB_TYPE == O )
      return osp_iter(Values, Starters, Results);
    // ####  END OF OPEN-SHOP  ####
    
    // ####  JOB-SHOP ####
    if ( (PROB_TYPE==J) || (PROB_TYPE==F) )
      return jsp_iter(Values, Starters, Results);
    // ####  END OF JOB-SHOP  ####
    return -1;
  }
